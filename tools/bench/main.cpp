// nano-bench — prompt-processing (pp) and token-generation (tg) throughput
...
int main(int argc, char ** argv) {
    ...
    if (mp.path.empty()) { fprintf(stderr, "usage: %s -m MODEL.gguf [-ngl N] [-pp 512] [-tg 128]\n", argv[0]); return 1; }
